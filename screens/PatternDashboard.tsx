  ...
  const renderIndividualHabit = (habitName: string) => {
    ...
    return (
      <ScrollView className="flex-1 px-6">
        ...
        {/* Common Triggers for This Habit */}
        <View
          className="rounded-2xl p-6 mb-6 border"
          style={{
            backgroundColor: "rgba(255, 255, 255, 0.1)",
        ...
        >
          ...
          <View className="space-y-4">
            {habitData.commonTriggers.map((item, index) => (
              <View
                key={index}
                ...
                <View className="flex-row items-center">
                  ...
                  >
                    <View
                      ...
                      style={{ width: `${(item.count / Math.max(...habitData.commonTriggers.map(t => t.count))) * 100}%` }}
                    />
                  </View>
        ...
        >
          ...
          <View className="space-y-4">
            {habitData.timePatterns.map((item, index) => (
              <View
                key={index}
                className="flex-row justify-between items-center"
              >
                ...
                <View className="flex-row items-center">
                  ...
                  >
                    <View
                      ...
                      style={{ width: `${(item.count / Math.max(...habitData.timePatterns.map(t => t.count))) * 100}%` }}
                    />
                  </View>
                  <Text className="text-white opacity-90 w-8">
                    {item.count}
